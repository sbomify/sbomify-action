...
def test_apply_skips_oidc_binding_for_private_repo(tmp_path: Path) -> None:
    """Private repos can't be resolved to immutable GitHub IDs (no PAT support),
    so skip the call and leave a note for the manual-instructions fallback."""
